...
from ..utils.language import get_prompt_language_instruction
...
class ReportAgent:
    ...
    def plan_outline(
        ...
        system_prompt = PLAN_SYSTEM_PROMPT + get_prompt_language_instruction()
    ...
    def _generate_section_react(
        ...
        system_prompt = get_prompt_language_instruction() + SECTION_SYSTEM_PROMPT_TEMPLATE.format(
    ...
    def chat(
        ...
        system_prompt = get_prompt_language_instruction() + CHAT_SYSTEM_PROMPT_TEMPLATE.format(
            simulation_requirement=self.simulation_requirement,
