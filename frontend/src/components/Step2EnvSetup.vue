    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ $t('step2.genDualPlatform') }}</span>
          </div>
          <div class="step-status">
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-block-header">
                ...
                <span class="config-block-badge">{{ simulationConfig.agent_configs?.length || 0 }} {{ $t('step2.units') }}</span>
              </div>
              <div class="agents-cards">
                ...
                >
                  ...
                  <div class="agent-timeline">
                    <span class="timeline-label">{{ $t('step2.activeSlots') }}</span>
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="topics-section">
              <span class="box-label">{{ $t('step2.initTrending') }}</span>
            ...
            <div class="initial-posts-section">
              <span class="box-label">{{ $t('step2.initActivation') }} ({{ simulationConfig.event_config.initial_posts.length }})</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ $t('step2.prepCompleteDesc') }}</p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">{{ $t('step2.autoPlanning') }} <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> {{ $t('step2.hours') }}，每轮代表现实 <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> {{ $t('step2.minutes') }}时间流逝</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>{{ $t('step2.estimatedTime') }} {{ Math.round(customMaxRounds * 0.6) }} {{ $t('step2.minutes') }}</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        {{ $t('step2.estimatedTime') }} {{ Math.round(autoGeneratedRounds * 0.6) }} {{ $t('step2.minutes') }}
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">{{ $t('step2.firstRunHint') }}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-section">
            <span class="section-label">{{ $t('step2.personaDesc') }}</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">{{ $t('step2.fullExpDesc') }}</span>
              </div>
              <div class="dimension-card">
